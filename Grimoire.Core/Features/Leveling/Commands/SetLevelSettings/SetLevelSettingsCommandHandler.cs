...
namespace Grimoire.Core.Features.Leveling.Commands.SetLevelSettings
{
    public class SetLevelSettingsCommandHandler : ICommandHandler<SetLevelSettingsCommand>
    {
        ...
        {
            var guild = await this._grimoireDbContext.GuildLevelSettings.FirstOrDefaultAsync(x => x.GuildId == command.GuildId, cancellationToken: cancellationToken);
            ...
            this._grimoireDbContext.GuildLevelSettings.Update(guild);
