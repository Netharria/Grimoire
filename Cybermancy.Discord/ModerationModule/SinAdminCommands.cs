...
using Cybermancy.Core.Features.Moderation.Commands.SinAdminCommands.PardonSin;
using Cybermancy.Core.Features.Moderation.Commands.SinAdminCommands.UpdateSinReason;
using Cybermancy.Core.Features.Moderation.Commands.SinAdminCommands.ForgetSin;
...
namespace Cybermancy.Discord.ModerationModule
{
    ...
    public class SinAdminCommands : ApplicationCommandModule
    {
            ...
            [Option("Reason", "The reason the sin is getting pardoned.")] string reason = "")
        {
            ...
            await ctx.ReplyAsync(CybermancyColor.Green, message, "Pardoned");
            ...
            [Option("Reason", "The reason the sin will be updated to.")] string reason = "")
        {
            ...
            await ctx.ReplyAsync(CybermancyColor.Green, $"Updated reason to {reason} for {message}");
            ...
            [Option("SinId", "The sin id that will be forgotten.")] long sinId)
        {
            ...
            await ctx.ReplyAsync(CybermancyColor.Green, message, "Forgot");
